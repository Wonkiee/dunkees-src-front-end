    ...
    const DeliveryDetailsForm = () => (
        <div className="Form-margin">
            ...
            <Form>
                ...
                <FormGroup row>
                    <Label sm={ { size: 2, offset: 1 } } align="left" for="exampleEmail">Contact Number</Label>
                    <Col sm={ { size: 8, offset: 0 } }>
                        <Input type="text" name="contactNumber" id="contactNumber" placeholder="07xxxxxxxx" />
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label sm={ { size: 2, offset: 1 } } align="left"  for="exampleAddress">Address</Label>
                    <Col sm={ { size: 8, offset: 0 } }>
                        <Input type="textarea" name="address1" id="address1" placeholder="1234 Main St, Jambugasmulla, Nugegoda"/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label sm={ { size: 2, offset: 1 } } align="left" for="exampleEmail">District</Label>
                    <Col sm={ { size: 8, offset: 0 } }>
                        <Input type="text" name="district" id="district" placeholder="Colombo"/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label sm={ { size: 2, offset: 1 } } align="left" for="exampleEmail">Zip Code</Label>
                    <Col sm={ { size: 8, offset: 0 } }>
                        <Input type="text" name="zip" id="zip" placeholder="(Optional)"/>
                    </Col>
                </FormGroup>
                <FormGroup row>
                    <Label sm={ { size: 2, offset: 1 } } align="left" for="exampleText">Delivery Notes</Label>
                    <Col sm={ { size: 8, offset: 0 } }>
